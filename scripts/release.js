...
async function main() {
  ...
  try {
    ...
    runCmd(`powershell -Command "Compress-Archive -Path dist/slab.exe, scripts, src/powershell, slab.default.config.json, slab-schema.json, setup.bat -DestinationPath dist/slab.zip -Force"`);
