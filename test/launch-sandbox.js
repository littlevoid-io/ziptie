...
try {
  ...
  if (runTests) {
    console.log(
      '\x1b[33mConfiguration: Automatically running automated integration tests at logon.\x1b[0m'
    );
  } else {
    console.log(
      '\x1b[33mConfiguration: Interactive session. Test script will NOT run automatically (open elevated terminal ready).\x1b[0m'
    );
  }
