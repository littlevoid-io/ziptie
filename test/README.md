...
- **Purpose:** Act as an early warning system. If any scoping changes in Pester 5 break cmdlet interception, the Canary test fails immediately, warning developers that the mock framework has been bypassed _before_ any downstream scripts can make unintended system modifications.
